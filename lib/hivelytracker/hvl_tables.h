...
const uint16_t lentab[45];

const int16_t vib_tab[64];

const uint16_t period_tab[61];

const int32_t stereopan_left[5];
const int32_t stereopan_right[5];

const int16_t filter_thing[2790];

int8_t waves[WAVES_SIZE];
