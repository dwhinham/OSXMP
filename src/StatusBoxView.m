...
- (void)drawRect:(NSRect)dirtyRect
{
    ...
    NSGradient *gradient = [[NSGradient alloc] initWithStartingColor:[NSColor colorWithCalibratedRed:0.5 green:0.5 blue:0.7 alpha:0.7]
														 endingColor:[NSColor colorWithCalibratedRed:0.3 green:0.5 blue:0.7 alpha:0.5]];
